...
def find_representative_anomaly_row(score_lot_df: pd.DataFrame, event_time: pd.Timestamp) -> pd.Series | None:
...
def is_action_completed(logs, process_name, lot, status):
    if not logs:
        return False
